...
* [SQL Buddy](https://wordpress.org/plugins/sql-buddy/) - Your one-stop solution for WordPress database management. Edit your table data with a clean and straightforward user interface.
